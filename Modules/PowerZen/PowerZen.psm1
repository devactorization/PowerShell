...
#ToDo: migrate to newer code structure that uses Invoke-ModuleApi internal function, and moving from credential object to ENVs, then test
...
function Connect-ZenApi {
    ...
    $Base64AuthInfo = "Basic $([System.Convert]::ToBase64String([System.Text.Encoding]::UTF8.GetBytes("$($ZendeskEmail):$($ApiKey)")))"
